...
namespace HelloWorld   
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IWeatherForecastUOW, WeatherForecastUOW>();
        ...
        protected virtual void ConfigureStore(IServiceCollection services)
        {
            ...
            services.AddDbContext<ForecastDbContext>(
                options => options.UseSqlServer(this.Configuration.GetConnectionString("WeatherForecastConnection")).ConfigureWarnings(warnings =>
                {
